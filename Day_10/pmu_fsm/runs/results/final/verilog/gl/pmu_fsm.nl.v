...
module pmu_fsm (clk,
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_10_124 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_11_17 ();
 ...
 sky130_fd_sc_hd__decap_4 FILLER_0_12_124 ();
 ...
 sky130_fd_sc_hd__decap_6 FILLER_0_16_121 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_20_120 ();
 ...
 sky130_fd_sc_hd__decap_8 FILLER_0_2_118 ();
 ...
 sky130_fd_sc_hd__nor2_1 _238_ (.A(_056_),
    .B(_035_),
    .Y(_011_));
 sky130_fd_sc_hd__dfstp_1 _239_ (.CLK(clknet_1_1__leaf_clk),
    .D(_001_),
    .SET_B(reset_n),
    .Q(net9));
 ...
 sky130_fd_sc_hd__dfrtp_1 _244_ (.CLK(clknet_1_1__leaf_clk),
    ...
    .RESET_B(reset_n),
    .Q(\seq_timer[4] ));
 sky130_fd_sc_hd__dfrtp_1 _245_ (.CLK(clknet_1_1__leaf_clk),
    .D(_009_),
    .RESET_B(reset_n),
    .Q(\seq_timer[5] ));
 ...
 sky130_fd_sc_hd__dfrtp_1 _250_ (.CLK(clknet_1_0__leaf_clk),
    ...
    .RESET_B(reset_n),
    .Q(net15));
 sky130_fd_sc_hd__dfrtp_1 _251_ (.CLK(clknet_1_0__leaf_clk),
    .D(_003_),
    .RESET_B(reset_n),
    .Q(net17));
 ...
 sky130_fd_sc_hd__dfrtp_1 _255_ (.CLK(clknet_1_1__leaf_clk),
    ...
    .RESET_B(reset_n),
    .Q(net13));
 sky130_fd_sc_hd__dfrtp_4 _256_ (.CLK(clknet_1_0__leaf_clk),
    .D(\next_state[0] ),
    .RESET_B(reset_n),
    .Q(\curr_state[0] ));
 sky130_fd_sc_hd__dfrtp_1 _257_ (.CLK(clknet_1_0__leaf_clk),
    ...
    .RESET_B(reset_n),
    .Q(\curr_state[1] ));
 sky130_fd_sc_hd__dfrtp_4 _258_ (.CLK(clknet_1_0__leaf_clk),
    .D(\next_state[2] ),
    .RESET_B(reset_n),
    .Q(\curr_state[2] ));
 sky130_fd_sc_hd__dfrtp_1 _259_ (.CLK(clknet_1_0__leaf_clk),
    ...
    .RESET_B(reset_n),
    .Q(\sync_stage1[0] ));
 sky130_fd_sc_hd__dfrtp_1 _260_ (.CLK(clknet_1_0__leaf_clk),
    .D(net4),
    .RESET_B(reset_n),
    .Q(\sync_stage1[1] ));
 ...
 sky130_fd_sc_hd__dlygate4sd3_1 hold1 (.A(req_idle),
    .X(net22));
 sky130_fd_sc_hd__dlygate4sd3_1 hold2 (.A(req_off),
    .X(net23));
 sky130_fd_sc_hd__dlygate4sd3_1 hold3 (.A(req_sleep),
    .X(net24));
 sky130_fd_sc_hd__clkbuf_1 input1 (.A(clk_stable),
    .X(net1));
 sky130_fd_sc_hd__clkbuf_1 input2 (.A(pwr_stable),
    .X(net2));
 sky130_fd_sc_hd__clkbuf_1 input3 (.A(net22),
    .X(net3));
 sky130_fd_sc_hd__clkbuf_1 input4 (.A(net23),
    .X(net4));
 sky130_fd_sc_hd__clkbuf_1 input5 (.A(net24),
    .X(net5));
